...
/**
 * Redis Hash 기반 WebSocket 세션 매니저.
 * PLAYER_TO_SESSION / SESSION_TO_PLAYER 두 Hash를 통해 플레이어 ↔ 세션 양방향 매핑을 관리한다.
 */
@Slf4j
@Component
public class StompSessionManager {
    ...
    public StompSessionManager(final StringRedisTemplate stringRedisTemplate) {
